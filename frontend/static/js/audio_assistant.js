...
(function() {
    ...
    // Variables locales del módulo (incluir TODAS las variables aquí)
    let mediaRecorder;
    let audioChunks = [];
    ...
    let finalTranscript = '';
    let currentAudioFilePath = null; // Movida dentro del módulo
    let allGeneratedAudioPaths = []; // Movida dentro del módulo
    ...
    function handleRecordedAudio() {
        ...
        try {
            ...
            // Guardar la referencia del audio actual
            currentAudioFilePath = audioUrl;
            allGeneratedAudioPaths.push(audioUrl);
